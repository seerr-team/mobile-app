...
const messages = getSeerrMessages('components.NotificationTypeSelector');
...
const NotificationTypeSelector = ({
  ...
  return (
    <View className="form-group mt-0">
      <View className="form-row">
        <ThemedText
          id="group-label"
          className="group-label mb-1 block font-bold leading-5 text-gray-400"
        >
          {intl.formatMessage(messages.notificationTypes)}
          {!user && <View className="label-required ml-1 text-red-500">*</View>}
        </ThemedText>
        <View className="form-input-area">
          <View className="flex max-w-lg gap-4">
