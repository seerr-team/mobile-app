    ...
    <View className="relative">
      ...
      >
        ...
        >
          ...
          />
          <View className="hide-scrollbar inline-block w-full scale-100 overflow-auto border border-gray-700 bg-gray-800 pb-4 pt-4 text-left opacity-100 transition-all sm:my-8 sm:max-w-3xl sm:rounded-lg">
            {backdrop && (
